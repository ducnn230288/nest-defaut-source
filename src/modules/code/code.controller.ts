...
import { CodeResponseDto, ListCodeResponseDto, CreateCodeRequestDto, UpdateCodeRequestDto } from './dto';
import { CodeService, P_CODE_LISTED, P_CODE_DETAIL, P_CODE_CREATE, P_CODE_UPDATE, P_CODE_DELETE } from './code.service';
...
export class CodeController {
  ...
  @Get(':id')
  async findOne(@I18n() i18n: I18nContext, @Param('id') id: string): Promise<CodeResponseDto> {
    return {
